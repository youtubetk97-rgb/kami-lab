...
export const products: Product[] = [
  ...
  },
  {
    ...
    brand: 'JR新橋駅徒歩1分のAGA治療クリニック',
    type: 'AGA専門クリニック（対面＋オンライン対応）',
    image: 'https://www20.a8.net/svt/bgt?aid=260917613598&wid=001&eno=01&mid=s00000009467001025000&mc=1',
    price: '自由診療・2ヶ月目以降は維持治療2,000〜7,150円/月、発毛治療9,700〜19,250円/月（税込・配送料別）',
    monthlyPrice: '初月1,000円（税込）〜',
    score: 4.3,
    scores: [
      { label: 'コスパ', value: 4.5 },
      { label: 'オンライン対応', value: 4.2 },
      { label: 'メニューの幅', value: 4.4 },
      { label: '続けやすさ', value: 4.2 },
    ],
    summary:
      '東京・新橋駅から徒歩1分に構えるAGA専門クリニックで、初診からのオンライン診療にも対応しています。初月はカウンセリング・初診料・薄毛検査・治療薬を含めて1,000円（税込）で、内服薬に加えてメソセラピーやLEDセラピーなど幅広いメニューを用意しています。',
    highlights: ['初月1,000円（税込）で診察・検査・治療薬を含む', '初診からオンライン診療に対応', '再診時は薬剤代のみ'],
    pros: [
      '初月1,000円（税込）から始められ、まず試しやすい料金設計',
      '対面での診察とオンライン診療のどちらも選べる',
      '内服薬のほか、メソセラピー・LEDセラピー・遺伝子診断など選択肢が広い',
    ],
    cons: [
      '対面院は新橋の1院で、オンライン診療では触診ができず、問診や写真での確認が中心になる',
      '発毛を目指す治療は月9,700〜19,250円と費用が上がる（自由診療・医療ローン非対応）',
      '水曜が休診日で、オンライン診療の配送料は別途かかる',
    ],
    ingredients: [
      '内服薬（フィナステリド／デュタステリド）',
      'ミノキシジル',
    ...
    guarantee: '自由診療のため、費用・返金条件などの詳細は公式サイトでご確認ください',
    affiliateUrl: 'https://px.a8.net/svt/ejp?a8mat=4BCDBH+9W18J6+211Q+63OY9',
    published: true,
  },
]
...
export const articles: Article[] = [
  ...
  },
  {
    ...
    body: [
      {
        type: 'lead',
        text: 'AGAクリニックは数多くあり、「とにかく安いところ」だけで選ぶと、実際に通い始めてから「思っていたメニューがなかった」「対応時間が合わなかった」と感じることもあります。ここでは比較する際に見ておきたいポイントと、当サイトで確認している3院の特徴を整理しました。',
      },
      ...
      { type: 'h2', text: '3院の特徴を比較する' },
      {
        type: 'p',
        text: 'ここでは、当サイトで公式サイトの情報をもとに確認している3院を紹介します。価格帯・対応の方向性がそれぞれ異なるため、自分が重視する条件と照らし合わせてみてください。',
      },
      { type: 'product', slug: 'levcli' },
      { type: 'product', slug: 'aga-skin-clinic' },
      { type: 'product', slug: 'gincli' },
      { type: 'h2', text: 'まとめ：迷ったら無料カウンセリングの比較から' },
      {
        type: 'p',
        text: 'オンライン診療のみで価格を抑えたい人はレバクリ、近くに院があり対面での相談やメニューの幅を重視したい人はAGAスキンクリニック、初月1,000円（税込）から対面・オンラインのどちらでも相談したい人は銀座総合美容クリニック（銀クリ）が選択肢になりやすい傾向です。ただし実際に合うかどうかは人によって異なるため、1院に絞らず複数の無料カウンセリングを受けて比較することをおすすめします。',
      },
      {
        type: 'note',
        title: 'この記事について',
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: 'p',
        text: 'ここでは、当サイトで公式サイトの情報をもとに確認している3院を紹介します。オンライン完結型か、対面の院もあるハイブリッド型かで特徴が異なるため、自分が重視する条件と照らし合わせてみてください。それぞれの料金・特徴の比較はAGAクリニックの選び方を扱った記事でも整理しています。',
      },
      { type: 'product', slug: 'levcli' },
      { type: 'product', slug: 'aga-skin-clinic' },
      { type: 'product', slug: 'gincli' },
  ...
  {
    slug: 'aga-treatment-safety',
    title: 'AGA治療は安全？副作用・注意点と安心して受けるためのチェックポイント',
    excerpt:
      '「副作用が心配で始められない」という声は少なくありません。AGA治療薬で添付文書に記載されている主な副作用と頻度の目安、PSA検査や献血への影響、クリニック選びで確認したいポイントを整理しました。',
    category: 'aga',
    publishedAt: '2026-09-20',
    updatedAt: '2026-09-20',
    readingTime: 9,
    image: '/images/hero-clinic.png',
    imageAlt: '医師から治療薬の説明を受けている様子',
    tags: ['AGA', '安全性', '副作用', 'フィナステリド'],
    body: [
      {
        type: 'lead',
        text: 'AGA治療を検討していても、「副作用が心配」「長く飲み続けて大丈夫なのか」と不安になり、一歩を踏み出せない人は少なくありません。AGA治療薬は国内で承認された医薬品であり、副作用や注意点は添付文書などで公表されています。ここでは、主な副作用と頻度の目安、服用中に知っておきたい注意点、安心して治療を受けるためのチェックポイントを整理します。',
      },
      {
        type: 'note',
        title: 'はじめに',
        text: '本記事は添付文書や公的機関・学会の公表情報をもとにした一般的な情報の整理であり、個別の診断・処方を行うものではありません。治療薬の適否や副作用への対応は、体質や持病によって異なるため、必ず医師の診察のもとで判断してください。',
      },
      { type: 'h2', text: 'まず知っておきたい前提：AGA治療は自由診療' },
      {
        type: 'p',
        text: 'AGA治療は健康保険の適用外となる自由診療で、治療内容や料金はクリニックごとに異なります。日本皮膚科学会の診療ガイドライン（2017年版）では、フィナステリド・デュタステリドの内服とミノキシジルの外用が、男性型脱毛症に対して最も推奨度の高い「A」とされています。一方、ミノキシジルの内服は、同ガイドラインで行わないよう勧められる区分にあたり、国内ではAGA治療薬として承認されていません。',
      },
      { type: 'h2', text: '添付文書に記載されている主な副作用' },
      { type: 'h3', text: 'フィナステリド' },
      {
        type: 'list',
        items: [
          '性欲減退：1〜5%未満',
          '勃起機能不全：1%未満',
          '肝機能障害：頻度不明（AST・ALTなどの上昇が報告されている）',
          'そのほか、発疹・かゆみなどの過敏症、抑うつ症状、めまいなどが記載されている',
        ],
      },
      {
        type: 'p',
        text: '性機能に関する症状は、服用を中止すると改善したとの報告がある一方で、市販後には中止後も症状が続いたとする報告もあり、添付文書に記載されています。頻度はいずれも高いものではありませんが、「起こりうるもの」として知ったうえで始めることが大切です。',
      },
      { type: 'h3', text: 'デュタステリド' },
      {
        type: 'p',
        text: 'フィナステリドと同じく5α還元酵素を阻害する薬で、性機能に関する症状など、似た傾向の副作用が添付文書に記載されています。注意点も共通する部分が多いため、服用前に医師や薬剤師から説明を受けましょう。',
      },
      { type: 'h3', text: 'ミノキシジル' },
      {
        type: 'list',
        items: [
          '外用：頭皮のかゆみ・かぶれなど局所の症状、使い始めの一時的な「初期脱毛」',
          '内服：動悸・むくみ・多毛など全身性の症状が報告されており、外用より注意が必要とされる',
        ],
      },
      {
        type: 'note',
        title: '「副作用は必ず起こるもの」ではありません',
        text: '上記は添付文書に記載されている「起こりうる症状」であり、すべての人に現れるものではありません。頻度の数値は臨床試験や市販後調査に基づく目安で、個人の体質や服用状況によって異なります。',
      },
      { type: 'h2', text: '治療を始める前に医師へ伝えておきたいこと' },
      {
        type: 'list',
        items: [
          '肝臓の病気や、健康診断で肝機能の数値を指摘されたことがあるか',
          '現在服用している薬・サプリメント、アレルギーの有無',
          '近いうちにパートナーとの妊活の予定があるか',
          '前立腺の検診を受けている、または今後受ける予定があるか',
        ],
      },
      {
        type: 'p',
        text: 'クリニックによっては、治療前や治療中に血液検査で肝機能などを確認できる場合があります。問診票にはこうした項目が含まれることが多いため、正確に回答しておくことが安全面での第一歩です。',
      },
      { type: 'h2', text: '服用中に知っておきたい注意点' },
      { type: 'h3', text: '前立腺がん検診（PSA検査）への影響' },
      {
        type: 'p',
        text: 'フィナステリドを服用すると、血液中のPSA（前立腺特異抗原）の値が約50%低下することが海外の臨床試験で報告されています。添付文書には、前立腺がんの診断目的でPSAを測定する場合は「2倍した値を目安に評価する」旨が記載されています。健康診断や人間ドックを受ける際は、AGA治療薬を服用していることを必ず申告しましょう。',
      },
      { type: 'h3', text: '献血' },
      {
        type: 'p',
        text: '日本赤十字社の案内では、フィナステリドは服用中止後1か月、デュタステリドは服用中止後6か月、献血ができないとされています。献血を予定している方は、事前に最寄りの血液センターの案内も確認してください。',
      },
      { type: 'h3', text: '女性・妊娠中の方との関わり' },
      {
        type: 'p',
        text: 'フィナステリド・デュタステリドは、妊娠中の女性が成分に触れると胎児に影響が及ぶ可能性があるとされています。錠剤を割ったり砕いたりしないこと、家族の薬の保管に注意することが求められます。女性の薄毛治療については、女性のAGA（FAGA）治療を扱った記事もあわせてご覧ください。',
      },
      { type: 'h2', text: '副作用が疑われたときの対応' },
      {
        type: 'list',
        items: [
          '気になる症状が出たら、いつから・どんな症状かをメモしておく',
          '自己判断で量を変えたり、急にやめたりせず、まず処方を受けた医師に連絡する',
          '発疹・息苦しさ・皮膚や白目が黄色くなるなど、強い症状がある場合は、早めに医療機関を受診する',
          '副作用の連絡窓口や再診の体制があるか、契約前に確認しておく',
        ],
      },
      { type: 'h2', text: '安全に受けるためのクリニック選びのチェックポイント' },
      {
        type: 'list',
        items: [
          '医師による問診・診察が行われ、既往歴や服用中の薬を確認してくれる',
          'メリットだけでなく、副作用やリスク、費用について事前に説明がある',
          '料金の内訳が公式サイトなどで明示されている',
          '副作用が心配なときに相談できる窓口や、再診の仕組みがある',
          '運営元や医師の情報が公開されており、実在する医療機関である',
          '「必ず生える」「100%」など、効果を断定する表現を使っていない',
        ],
      },
      {
        type: 'note',
        title: '海外通販・個人輸入との違い',
        text: '医療機関で処方される国内承認薬は、副作用が生じた場合に「医薬品副作用被害救済制度」の対象となることがありますが、個人輸入した薬は対象外です。個人輸入のリスクについては、海外通販・個人輸入のリスクを扱った記事で詳しく解説しています。',
      },
      {
        type: 'p',
        text: '診察や相談の体制を確認する際の参考として、当サイトで公式サイトの情報をもとに確認している3院を紹介します。オンライン完結型か、対面の院もあるタイプかで特徴が異なるため、自分に合う受診方法を選んでください。',
      },
      { type: 'product', slug: 'levcli' },
      { type: 'product', slug: 'aga-skin-clinic' },
      { type: 'product', slug: 'gincli' },
      { type: 'h2', text: 'まとめ' },
      {
        type: 'list',
        items: [
          'AGA治療薬には、性機能に関する症状や肝機能障害など、添付文書に記載された副作用があり、頻度はいずれも高くはない',
          'フィナステリド服用中はPSA検査の値が低く出るため、検診時に必ず申告する',
          '献血はフィナステリドで中止後1か月、デュタステリドで中止後6か月できない',
          '副作用が疑われたら自己判断で中断せず、まず医師に相談する',
          '医師の診察・リスクの説明・相談窓口がそろったクリニックを選ぶ',
        ],
      },
      {
        type: 'note',
        title: 'この記事について',
        text: '本記事は、添付文書、日本皮膚科学会の診療ガイドライン（2017年版）、日本赤十字社の案内などの公表情報をもとに整理した一般的な情報です。特定の治療薬やクリニックの安全性を保証するものではなく、効果や副作用には個人差があります。実際の治療方針は、必ず医師にご相談ください。',
      },
    ],
  },
]
