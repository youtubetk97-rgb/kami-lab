...
export const articles: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: 'p',
        text: 'ここでは、当サイトで公式サイトの情報をもとに確認している3院を紹介します。価格帯・拠点数・対応の方向性がそれぞれ異なるため、自分が重視する条件と照らし合わせてみてください。',
      },
      ...
      {
        type: 'p',
        text: 'オンライン診療のみで価格を抑えたい人はレバクリ、近くに院があり対面での相談やメニューの幅を重視したい人はAGAスキンクリニック、初期費用を抑えてまず試したい人は銀座総合美容クリニックが選択肢になりやすい傾向です。ただし実際に合うかどうかは人によって異なるため、1院に絞らず2〜3院の無料カウンセリングを受けて比較することをおすすめします。',
      },
      {
        type: 'note',
        title: 'この記事について',
